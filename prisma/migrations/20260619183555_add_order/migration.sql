...
INSERT INTO "new_Language" ("createdAt", "flag", "id", "isActive", "lettersApplicable", "lettersFile", "name", "native", "patternsApplicable", "patternsFile", "updatedAt", "wordsApplicable", "wordsFile") SELECT "createdAt", "flag", "id", "isActive", "lettersApplicable", "lettersFile", "name", "native", "patternsApplicable", "patternsFile", "updatedAt", "wordsApplicable", "wordsFile" FROM "Language";
DROP TABLE "Language";
